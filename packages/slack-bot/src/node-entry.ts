/**
 * Node.js entry point for the Open-Inspect Slack Bot.
 *
...
serve({
  fetch: (request, _env) => {
    const nodeEnv = {
      ...
      CLASSIFICATION_MODEL: process.env.CLASSIFICATION_MODEL || "anthropic/claude-haiku-4-5",
...
console.log(`[slack-bot] Node.js server running on http://localhost:${PORT}`);
